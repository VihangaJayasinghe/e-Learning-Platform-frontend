...
import { getClassById, type Class } from "../services/api";
...
const AdminClassDetails: React.FC = () => {
    ...
    const fetchClassDetails = async (classId: string) => {
        ...
        try {
            ...
            // Map the response to ensure instructorName exists
            const adaptedData: Class = {
                ...data,
                instructorName: data.instructorName || data.teacher?.username || "Unknown",
                // Ensure months is an array
                months: Array.isArray(data.months) ? data.months : []
            };
            setClassDetails(adaptedData);
        } catch (err: any) {
